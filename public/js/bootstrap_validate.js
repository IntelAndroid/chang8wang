...
function v_tdecimal (id,fname) {
    var thisobj=$("#"+id);
    var number_str=thisobj.val();
    var parent = thisobj.parent();
    var root=parent.parent();
    if(fname==undefined){fname="";}
    var msg=fname+"必须为数字，最多三位小数！";
    ...
    if(number_str!=undefined&&number_str!=""&& !root.hasClass("has-error")){
        ...
        root.removeClass("has-error");
        root.removeClass("has-success");
        if(!/^[-+]?(0|[1-9][0-9]*)(\.[0-9]{1,3})?$/.test(number_str)&&!root.hasClass("has-error")){
            root.addClass("has-error");
            toastr.error(msg);
            return false;
        }else if(!root.hasClass("has-error")){
...
function v_lat (id,fname) {
    var thisobj=$("#"+id);
    var number_str=thisobj.val();
    var parent = thisobj.parent();
    var root=parent.parent();
    if(fname==undefined){fname="";}
    var msg=fname+"请填写正确经度！";
    ...
    if(number_str!=undefined&&number_str!=""&& !root.hasClass("has-error")){
        ...
        root.removeClass("has-error");
        root.removeClass("has-success");
        if(!/^[\-\+]?(0?\d{1,2}\.\d{1,10}|1[0-7]?\d{1}\.\d{1,10}|180\.0{1,10})$/.test(number_str)&&!root.hasClass("has-error")){
            root.addClass("has-error");
            toastr.error(msg);
            return false;
        }else if(!root.hasClass("has-error")){
...
function v_lot(id,fname) {
    var thisobj=$("#"+id);
    var number_str=thisobj.val();
    var parent = thisobj.parent();
    var root=parent.parent();
    if(fname==undefined){fname="";}
    var msg=fname+"请填写正确纬度！";
    ...
    if(number_str!=undefined&&number_str!=""&& !root.hasClass("has-error")){
        ...
        root.removeClass("has-error");
        root.removeClass("has-success");
        if(!/^[\-\+]?([0-8]?\d{1}\.\d{1,10}|90\.0{1,10})$/.test(number_str)&&!root.hasClass("has-error")){
            root.addClass("has-error");
            toastr.error(msg);
            return false;
        }else if(!root.hasClass("has-error")){
...
$(function(){
    ...
    $(".tdecimal").blur(function(){
        v_tdecimal($(this).attr("id"),$(this).attr("placeholder"));
    }).focus(function(){
        var root=$(this).parent().parent();
        root.removeClass("has-error").removeClass("has-success");
    });
    ...
    $(".lat").blur(function(){
        v_lat($(this).attr("id"),$(this).attr("placeholder"));
    }).focus(function(){
        var root=$(this).parent().parent();
        root.removeClass("has-error").removeClass("has-success");
    });
    $(".lot").blur(function(){
        v_lot($(this).attr("id"),$(this).attr("placeholder"));
    }).focus(function(){
        var root=$(this).parent().parent();
        root.removeClass("has-error").removeClass("has-success");
    });
